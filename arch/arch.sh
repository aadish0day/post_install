...
i3wm_packages=(
    ...
    nwg-look mpv network-manager-applet numlockx playerctl polkit-gnome rofi scrot
    ...
    gssproxy gst-libav gst-plugins-bad gst-plugins-ugly gtksourceview3 haveged hdparm
    hwdetect hwinfo imagemagick inetutils inxi jemalloc less libavtp libdca libgme
    libgsf libinstpatch liblqr liblrdf libltc libmaxminddb libmbim libmicrodns
    libmpeg2 libopenraw libpipeline libqmi libqrtr-glib libwnck3 libx86emu libxres
    linux-headers logrotate lsb-release man-db man-pages mjpegtools modemmanager
    net-tools netctl networkmanager-openconnect networkmanager-openvpn nfs-utils
    nfsidmap nss-mdns ntp oath-toolkit openconnect openh264 openvpn os-prober pacutils
    parallel perl-xml-writer pkcs11-helper pkgfile plocate poppler-glib ppp pv
    ...
    svt-hevc systemd-resolvconf tcl ttf-bitstream-vera ttf-dejavu ttf-liberation
    ttf-opensans usb_modeswitch usbutils clipmenu
)
