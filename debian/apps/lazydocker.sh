...
# ============================================================================
# DEBIAN / UBUNTU LAZYDOCKER INSTALLER (CLI / TUI)
...
echo "=== Installing Lazydocker CLI on Debian / Ubuntu ==="
...
if ! command -v docker &>/dev/null; then
    ...
    if [ -f "$SCRIPT_DIR/docker.sh" ]; then
        read -rp "Would you like to install Docker now using debian/apps/docker.sh? (y/n): " install_docker_choice
