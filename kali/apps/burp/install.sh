...
if command -v nala &>/dev/null; then
    sudo nala install -y openjdk-21-jre git aria2
else
    sudo apt update -qq && sudo apt install -y openjdk-21-jre git aria2
fi
...
echo "=== Burp Suite Professional installation completed successfully! ==="
